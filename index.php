...
<div class="jumbotron jumbotron-fluid">
    <div class="container">
        ...
        <p class="lead"><span class="ergdn">ERGDN</span> Notebook is a basic PHP notebook and to-do list application.
...
<?php  
// Adding a note before retrieving note data
...
// Adding a todo item before retrieving todo data
        ...
        <div id="content">
            <form action="index.php" method="POST">
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Please enter your note</label>
